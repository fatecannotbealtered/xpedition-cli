...
OUTPUT_SCHEMA = {
    "shape": "object",
    "fields": ["library", "selected_type", "scope", "items", "count", "offset", "next_offset",
               "has_more", "total", "complete_in_scope", "issue_count", "issues",
               "issues_truncated", "execution", "semantic_validation", "source", "_untrusted"],
...
def command() -> dict[str, Any]:
    return {
        "path": "system api-inventory", "type": "query", "permission_tier": "read",
        "description": ("Inspect trusted standalone COM type-library metadata "
                        "without activating EDA"),
        "output_schema": "api_inventory", "blast_radius": "none; metadata inspection only",
        "examples": [
        ...
        "params": [
            ...
            {"name": "name", "type": "string", "required": False, "multiple": False,
             "description": ("Exact unique type name; select member metadata "
                             "rather than type headers")},
        ...
        "native_application_activation": False, "registration_requested": False,
